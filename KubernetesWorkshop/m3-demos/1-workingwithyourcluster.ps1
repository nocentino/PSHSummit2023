...
#You should have two pods here...and the status shouold be Running
...
#Pods are just containers...so you can see that kubernetes starts up the containers on this node
docker ps 
...
#And check the current configuration of our deployment...you should see 20/20...wait for the status to change to running
kubectl get deployment hello-world
